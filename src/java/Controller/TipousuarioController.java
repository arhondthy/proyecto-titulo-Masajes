...
public class TipousuarioController implements Serializable {
    ...
    private List<Tipousuario> paraRegistro = null;
    ...
    public List<Tipousuario> getParaRegistro() {

        paraRegistro = new ArrayList<>();
        items = getFacade().findAll();
        if (LoginController.usuario == null) {
            for (Tipousuario tipousuario : items) {
                if (tipousuario.getTipUsuId().equals(constantes.Constant.TIPO_USUARIO_CLIENTE)) {
                    paraRegistro.add(tipousuario);
                }
            }
        } else {
            paraRegistro = items;
    ...
    public void setParaRegistro(List<Tipousuario> paraRegistro) {
        this.paraRegistro = paraRegistro;
    }
    ...
    public static class TipousuarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tipousuario) {
                ...
                return getStringKey(o.getTipUsuId());
            } else {
